...
import { 
  ...
  Loader2, BarChart3, Target, Star, FolderOpen
} from 'lucide-react';
...
export default function ProfileViewDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[95vw] max-w-[1280px] h-[min(720px,90vh)] flex flex-col p-0 gap-0 overflow-hidden" style={{ maxHeight: 'min(720px, 90vh)', minHeight: 'min(720px, 90vh)' }}>
        ...
        <div className="flex flex-1 min-h-0">
          ...
          <div className="w-[320px] shrink-0 border-r bg-gradient-to-b from-primary/5 via-background to-background flex flex-col">
            {/* UEH-style header stripe */}
